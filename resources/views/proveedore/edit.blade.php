...
<div class="container-fluid px-4 blurred">
    <h1 class="mt-4 title"><i class="fa-solid fa-users icons"></i>Editar Proveedor</h1>
    ...
    <div class="card text-bg-light">
        <form action="{{ route('proveedores.update',['proveedore'=>$proveedore]) }}" method="post">
            ...
            <div class="col-12 mt-3 text-center">
                ...
                <button type="reset"  class="btn btn-danger" onclick="window.location='{{ route('proveedores.index') }}'" >Cancelar</button>
            </div>
        </form>
    </div>
