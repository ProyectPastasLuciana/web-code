...
<link href="{{asset('css/marca/marca_index.css')}}" rel="stylesheet" />
@endpush
...
<div class="container-fluid px-4 blurred">
    <h1 class="mt-4 title"><i class="fa-solid fa-square-check icons"></i>Marcas</h1>
                ...
                @foreach ($marcas as $marca)
                    <tr>
                        ...
                        <td><!--Botones-->
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                @if ($marca->caracteristica->estado == 1)
                                    <button type="button" class="btn btn-danger size_btn" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$marca->id}}" >Eliminar</button>
                                @else
                                <button type="button" class="btn btn-success size_btn" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$marca->id}}" >Restaurar</button>
                                @endif
                              </div>
                        </td>
                    </tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{$marca->caracteristica->estado == 1 ? '¿Seguro seguro de eliminar esta marca?': '¿Seguro seguro de restaurar esta marca?'}} 
                        </div>
